...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		...
		<li class="nav-item">
                                <a class="nav-link" href="{!! route('admins.assignRole') !!}"><i
                                            class="fa fa-plus mr-2"></i>Assign Role</a>
                            </li>
		</ul>
		</div>
		<div class="card-header">
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
		<li class="nav-item">
                                <a class="nav-link" href="{!! route('admins.createRole') !!}"><i
                                            class="fa fa-plus mr-2"></i>Create Role</a>
                            </li>
		</ul>
		</div>
