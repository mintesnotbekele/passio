            ...
            <div class="vendor_payout_create-inner">
                ...
                <fieldset>
                    ...
                    <div class="form-group row width-50">
                        ...
                        <div class="col-7">
                            <button type="button" onclick="getLocation()" class="btn btn-primary"><i
                                class="fa fa-save"></i>Get Co-ordinates</button>
                    ...
                    <div class="form-group row width-50">
                        ...
                        <div class="col-7">
                            <input id="userlat" class="form-control latitude" type="number" min="-90" max="90" onkeypress="return chkAlphabets3(event,'error1')"><div id="error1" class="err"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row width-50">
                        ...
                        <div class="col-7">
                            <input id="userlong" class="form-control longitude" type="number" min="-180" max="180" onkeypress="return chkAlphabets3(event,'error2')"><div id="error2" class="err"></div>
                        </div>
                    </div>
