					...
					<div class="vendor_payout_create-inner">
						...
						<fieldset>
							...
							<div class="form-group row width-50">
								...
								<div class="col-7">
									<input type="text" class="form-control city" onkeypress="return chkAlphabets(event,'error2')"><div id="error2" class="err"></div>
									<div class="form-text text-muted w-50">
							...
							<div class="form-group row width-50">
								...
								<div class="col-7">
									<input type="text" class="form-control country" onkeypress="return chkAlphabets(event,'error3')"><div id="error3" class="err"></div>
									<div class="form-text text-muted w-50">
							...
							<div class="form-group row width-50">
								...
								<div class="col-7">
									<input type="text" class="form-control postalcode" onkeypress="return chkAlphabets2(event,'error4')"><div id="error4" class="err"></div>
									<div class="form-text text-muted w-50">
							...
							<div class="form-group row width-50">
								...
								<div class="col-7">
									<input id="userlat" type="text" class="form-control user_latitude" onkeypress="return chkAlphabets3(event,'error5')"><div id="error5" class="err"></div>
									<div class="form-text text-muted w-50">
							...
							<div class="form-group row width-50">
								...
								<div class="col-7">
									<input  id="userlong" type="text" class="form-control user_longitude" onkeypress="return chkAlphabets3(event,'error6')"><div id="error6" class="err"></div>
									<div class="form-text text-muted w-50">
		...
		if (userFirstName == '') {
			...
			firebase.auth().createUserWithEmailAndPassword(email, password)
				.then(function (firebaseUser) {
					...
					geoFirestore.collection('users').doc(user_id).set({
