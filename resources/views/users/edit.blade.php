                ...
                <div class="vendor_payout_create-inner">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group row width-50">
                            ...
                            <div class="col-7">
                                <input type="text" class="form-control city" onkeypress="return chkAlphabets(event,'error3')">
                        ...
                        <div class="form-group row width-50">
                            ...
                            <div class="col-7">
                                <input type="text" class="form-control country" onkeypress="return chkAlphabets(event,'error4')">
                        ...
                        <div class="form-group row width-50">
                            ...
                            <div class="col-7">
                                <input type="text" class="form-control postalcode" onkeypress="return chkAlphabets2(event,'error5')">
