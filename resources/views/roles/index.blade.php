                        ...
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                            <li class="nav-item">
                                <a class="nav-link active" href="{!! url()->current() !!}"><i
                                            class="fa fa-list mr-2"></i>Roles Table</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{!! route('roles.create') !!}"><i
                                            class="fa fa-plus mr-2"></i>Create Roles</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody id="append_list1">
                                        ...
                                        <td class="delete-all">
                                            ...
                                            <td class="action-btn">
                                                ...
                                                <a class="btn btn-danger delete-button" data-id="{{ $role->id }}" data-target="#deleteModal" name="user-delete" href="javascript:void(0)">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" class="btn btn-danger confirm-delete-button">Delete</button>
                                                        </div>
                                                        </div>
                                                    </div>
                                                    </div>
...
<script type="text/javascript">
  ...
  $('.delete-button').click(function(event) {
    ...
    $('.confirm-delete-button').click(function() {
      // Send AJAX request to delete the item with itemId
      $.ajax({
        url: '/items/' + itemId,
        method: 'DELETE',
