                        ...
                        <div class="vendor_payout_create-inner">
                            ...
                            <div class="form-text text-muted"></div>
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input id="userlat"  class="form-control vendor_latitude" type="number" min="-90" max="90"
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input  id="userlong" class="form-control vendor_longitude" type="number" min="-180" max="180"
