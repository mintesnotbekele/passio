                        ...
                        <div class="vendor_payout_create-inner">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7 driverlecense_image">
                                    </div>
                                </div>
                                <div class="form-group row width-50">
                                    <label class="col-3 control-label"> driver ID card/Passport </label>
                                    <div class="col-7  idcard_image">
                                    </div>
                                </div>
                               
                                <div class="form-group row width-50">
                                    <label class="col-3 control-label"> Vehicle Registration license </label>
                                    <div class="col-7 registration_image">
                                    </div>
                                </div>
                            <div class="form-group row width-50">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(async function () {
            ...
            ref.get().then(async function (snapshots) {
                ...
                var imageDriverLicence = "";
                if (dirver.driverLiscence) {
                    imageDriverLicence = '<img width="200px" id="" height="auto" src="' + dirver.driverLiscence + '">';
                } else {
                    imageDriverLicence = '<img width="200px" id="" height="auto" src="' + placeholderImage + '">';
                }
                $(".driverlecense_image").html(imageDriverLicence);

                var imageVehicleRegistration = "";
                if (dirver.vehicleRegistration) {
                    imageVehicleRegistration = '<img width="200px" id="" height="auto" src="' + dirver.vehicleRegistration + '">';
                } else {
                    imageVehicleRegistration = '<img width="200px" id="" height="auto" src="' + placeholderImage + '">';
                }
                $(".registration_image").html(imageVehicleRegistration);

                var imagedriverIdCard = "";
                if (dirver.driverIdCard) {
                    imagedriverIdCard = '<img width="200px" id="" height="auto" src="' + dirver.driverIdCard + '">';
                } else {
                    imagedriverIdCard = '<img width="200px" id="" height="auto" src="' + placeholderImage + '">';
                }
                $(".idcard_image").html(imagedriverIdCard);
