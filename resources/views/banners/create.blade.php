            ...
            <div class="col-md-7 align-self-center">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a
                                href="{!! route('banners') !!}">{{trans('lang.menu_items')}}</a>
                    </li>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group row width-50">
                            ...
                            <div class="col-7">
                                ...
                                <optgroup label="Multivendor Delivery Service">
                                    
                                </optgroup>
                                <optgroup label="Ecommerce Service"> 
                                <option></option>
                                </optgroup>
                                <optgroup label="Cab Service">
        ...
        <div class="card-body">
            ...
            <div class="row vendor_payout_create">
                ...
                <div class="vendor_payout_create-inner">
                    <fieldset>
                        <legend>
                            Users App Phone Dashboard slider Banners
                        </legend>

                        <div class="form-group row width-50">

                            <label class="col-3 control-label">first</label>
                            <div class="col-7">
                                <input type="file" id="banner_first_img">
                                <div id="uploding_image"></div>
                            </div>
                            <div class="placeholder_img_thumb user_image"></div>
                        </div>
                        <div class="form-group row width-50">
                            <label class="col-3 control-label">Second</label>
                            <div class="col-7">
                                <input type="file" id="banner_second_img">
                                <div id="uploding_image"></div>
                            </div>
                            <div class="placeholder_img_thumb user_image"></div>
                        </div>
                        <div class="form-group row width-50">
                            ...
                            <label class="col-3 control-label">third</label>
                            <div class="col-7">
                                <input type="file" id="banner_third_img">
                                <div id="uploding_image"></div>
                            </div>
                            <div class="placeholder_img_thumb user_image"></div>
                        </div>
...
<script type="text/javascript">
    ...
    $("#section_id").change(function () {
        ...
        if (service_type == "ecommerce-service" || service_type == "delivery-service" || service_type == "cab-service") {
